//----------------------------- Matter JS For Loader Script -----------------------------//

// You have the license to use this code in your projects but not redistribute it to others

$(".matter-loader-view").one("inview", function (event, isInView) {
  if (isInView) {
    ...
    const content = document.querySelector(".loader-canvas");
    ...
    let tricksArea = document.querySelector(".loader-elements");
...
// Snap Into View
$(".matter-loader-view").on("inview", function (event, isInView) {
  if (isInView) {
    $(".loader-m-link").click();
  } else {
  }
